...
ifndef SDK_ROOT
$(error Set environment variable 'SDK_ROOT' specifying the NRF5 SDK folder path)
endif

ifndef GNU_INSTALL_ROOT
$(error Set environment variable 'GNU_INSTALL_ROOT' specifying the path to the `bin` directory inside the toolchain folder)
endif

$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := walter.ld
